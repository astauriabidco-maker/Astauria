...
let CaseStudiesService = class CaseStudiesService {
    ...
    async create(data) { return this.prisma.caseStudy.create({ data }); }
    ...
    async findBySlug(slug) { return this.prisma.caseStudy.findUnique({ where: { slug } }); }
    async update(id, data) { return this.prisma.caseStudy.update({ where: { id }, data }); }
    async remove(id) { return this.prisma.caseStudy.delete({ where: { id } }); }
};
