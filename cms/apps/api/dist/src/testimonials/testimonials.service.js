...
let TestimonialsService = class TestimonialsService {
    ...
    async create(data) { return this.prisma.testimonial.create({ data }); }
    ...
    async update(id, data) { return this.prisma.testimonial.update({ where: { id }, data }); }
    async remove(id) { return this.prisma.testimonial.delete({ where: { id } }); }
};
